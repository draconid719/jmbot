$(function(){
    ...
    $('#shoutbox-comment').keydown(function (event) {
    ...
    function load(){
         ...
         $.ajax({
            ...
            success:function(data){
                ...
                appendComments(data);
                var objDiv = document.getElementById("shoutcontent");
    ...
    function appendComments(data) {
        ...
        data.forEach(function(d){
            ul.append('<li>'+
                ...
                '<p class="shoutbox-comment">' + emojione.toImage(emojione.escapeHTML(d.text)) + '</p>'+
